...
# (new author_embedding layer is incompatible with old checkpoints).
#
# Usage:
#   nohup bash train_pt_author_fixrt.sh <GPU_ID> > pt_author_1000.log 2>&1 &
# =============================================================================
...
echo "############################################################"
echo "# PT [AUTHOR] stage (author embeddings), GPU ${GPU}"
