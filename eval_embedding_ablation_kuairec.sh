...
#   FORCE_REEVAL=1 CUDA_VISIBLE_DEVICES=0 bash eval_embedding_ablation_kuairec.sh
#   FORCE_REEVAL=1 nohup bash eval_embedding_ablation_kuairec.sh > eval_ablation.log 2>&1 &
#
