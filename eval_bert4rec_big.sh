#!/bin/bash
# =============================================================================
# STANDALONE big-matrix BERT4Rec evaluation (eval-only, existing checkpoints).
# Outputs: baseline_results_<variant>/bert4rec_results.txt
# Usage: bash eval_bert4rec_big.sh [GPU_ID]
# =============================================================================
cd "$(dirname "$0")"
...
for VAR in "${VARIANTS[@]}"; do
    ...
    python3 bert4rec_pytorch.py \
        ...
        --output "${OUT_DIR}/bert4rec_results.txt" 2>&1 | tee "eval_bert4rec_${VAR}.log"
done

echo "BERT4REC BIG-MATRIX EVALS DONE"
