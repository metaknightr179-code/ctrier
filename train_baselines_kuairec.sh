#!/bin/bash
# Train SASRec + GRU4Rec baselines on KuaiRec (4 variants).
# BERT4Rec is intentionally EXCLUDED — run it separately with:
...
# Checkpoints -> save_sasrec_<variant>/ save_gru4rec_<variant>/
...
echo "ALL KUAIREC BASELINES COMPLETE (SASRec + GRU4Rec; BERT4Rec: train_bert4rec_kuairec.sh)"
